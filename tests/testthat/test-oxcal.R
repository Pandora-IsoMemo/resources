...
test_that("Create OxCal Output", {
  ...
  basicCode <- c("Plot()", "{", "%%Terrestrial_curve_VAR1%%", "%%Aquatic_curve_1_VAR1%%", 
  ...
  terrestrialCurves <- list(
    ...
    list(title = "SHCal20",
         ...
         mixture = list()), 
    list(title = "Known mix IntCal20 andSHCal20 - must give mix values in text", 
         formula = c("Curve(\"IntCal20\",\"IntCal20.14c\");", "Curve(\"SHCal20\",\"SHCal20.14c\");", 
                     "Mix_Curves(\"terrestrial\",\"IntCal20\",\"SHCal20\", Mean,SD);"
         ),
         mixture = list()),
    list(title = "Unknown mix IntCal20 andSHCal20", 
         formula = c("Curve(\"IntCal20\",\"IntCal20.14c\");", "Curve(\"SHCal20\",\"SHCal20.14c\");", 
  ...
  aquaticCurves1 <- list(
    list(title = "Marine20",
         formula = c("Curve(\"Marine20\",\"Marine20.14c\");", 
                     "Delta_R(\"Aquatic1\",%%Delta_R_1%%,%%Delta_R_SD_1%%);"),
         mixture = list(
           c("Mix_Curve(%%TARGET_ID%%,\"terrestrial\",\"Aquatic1\", %%MEAN%%,%%SD%%);", 
             "R_Date(“%%TARGET_ID%%“, %%RADIOCARBON_MEAN%%,%%RADIOCARBON_SD%%);"
           ), c("Mix_Curve(%%TARGET_ID%%,\"terrestrial\",\"Aquatic1\", P(0,100,[0,%%BINS%%,0]));", 
                "R_Date(“%%TARGET_ID%%“, %%RADIOCARBON_MEAN%%,%%RADIOCARBON_SD%%);"
           ))), 
    list(title = "IntCal20", 
         formula = c("Curve(\"IntCal20\",\"IntCal20.14c\");", 
                     "Delta_R(\"Aquatic1\",%%Delta_R_1%%,%%Delta_R_SD_1%%);"),
         mixture = list(
           "Mix_Curve(%%TARGET_ID%%,\"terrestrial\",\"Aquatic1\", %%MEAN%%,%%SD%%);", 
           "Mix_Curve(%%TARGET_ID%%,\"terrestrial\",\"Aquatic1\", P(0,100,[0,%%BINS%%,0]));")), 
    list(title = "SHCal20",
         formula = c("Curve(\"SHCal20\",\"SHCal20.14c\");", 
                     "Delta_R(\"Aquatic1\",%%Delta_R_1%%,%%Delta_R_SD_1%%);"), 
         mixture = list("Mix_Curve(%%TARGET_ID%%,\"terrestrial\",\"Aquatic1\", %%MEAN%%,%%SD%%);", 
                        "Mix_Curve(%%TARGET_ID%%,\"terrestrial\",\"Aquatic1\", P(0,100,[0,%%BINS%%,0]));")), 
    list(title = "Known mix IntCal20 andSHCal20 - must give mix values in text", 
         formula = c("Curve(\"IntCal20\",\"IntCal20.14c\");", 
  ...
  aquaticCurves2 <- list(
    ...
    list(title = "IntCal20",
         formula = c("Curve(\"IntCal20\",\"IntCal20.14c\");", 
                     "Delta_R(\"Aquatic2\",%%Delta_R_2%%,%%Delta_R_SD_2%%);"), 
         mixture = list("Mix_Curve(%%TARGET_ID%%,\"Aquatic1\",\"Aquatic2\", %%MEAN_B%%,%%SD_B%%);", 
                        "Mix_Curve(%%TARGET_ID%%,\"Aquatic1\",\"Aquatic2\", P(0,100,[0,%%BINS_B%%,0]));")), 
    list(title = "SHCal20",
         formula = c("Curve(\"SHCal20\",\"SHCal20.14c\");", 
                     "Delta_R(\"Aquatic2\",%%Delta_R_2%%,%%Delta_R_SD_2%%);"), 
  ...
  exportCoordinates <- structure(
    ...
    .Dim = 5:4,
    .Dimnames = list(c("Individual_1", "Individual_2", "Individual_3", "Individual_4", "Individual_5"),
                     c("longitude", "latitude", "LowerLimit/Mean/Point", "UpperLimit/SD"))
    )
  
  oxcalLines1 <- createOxCalText(model = model,
                                 basicCode = basicCode,
  ...
  oxcalLines2 <- createOxCalText(model = model,
                                 basicCode = basicCode,
                                 terrestrialCurve = terrestrialCurves[1], 
                                 aquaticCurve1 = aquaticCurves1[1], 
                                 aquaticCurve2 = aquaticCurves2[1],
  ...
  expect_equal(oxcalLines1[9] %>% substr(start = 1, stop = 100),
               "Mix_Curve(Individual_1,\"terrestrial\",\"Aquatic1\", 0.511,0.29); R_Date(“Individual_1“, NA,NA);")
  expect_equal(oxcalLines1[23] %>% substr(start = 1, stop = 100),
  ...
  expect_equal(oxcalLines2[9] %>% substr(start = 1, stop = 100),
               "Mix_Curve(Individual_1,\"terrestrial\",\"Aquatic1\", P(0,100,[0,0, 0, 0.001, 0.002, 0.007, 0.013, 0.018,")
  expect_equal(oxcalLines2[23] %>% substr(start = 1, stop = 100),
